      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="card">
            ...
            <input type="email" data-testid="admin-email-input" id="admin-email-input" class="form-control" placeholder="johndoe@email.com" required autofocus>
            <label for="admin-password-input">Mot de passe</label>
            <input type="password" data-testid="admin-password-input" id="admin-password-input" class="form-control" placeholder="******" required>
